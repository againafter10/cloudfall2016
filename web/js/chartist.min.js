...
{ 
	...
	new Chartist.Bar('#chart2', {
	    labels: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri'],
	    series: [[5, 2, 8, 3], [1, 3, 2, 1, 1], [1, 3, 5, 2, 4]]
	  });
		
	var chart = new Chartist.Line('#chartHours', {
		labels: ['Santa Clara', 'Milpitas', 'Fremont', 'San Jose', 'SF'],
		  series: [
		    [1, 5, 5, 4, 3],
		    [2, 3, 8, 1, 2],
		    [1, 2, 2, 3, 1]
...
function initialize()
{
    ...
    console.log("Hello");
  var myLatLngSanJose = new google.maps.LatLng(37.338208,-121.886329);
  var myLatLngFremont = new google.maps.LatLng(37.5483,-121.9886);
  var myLatLngCampbell = new google.maps.LatLng(37.2872,-121.9500);
  var myLatLngMilpitas = new google.maps.LatLng(37.4323,-121.8996);
  var myLatLngSFO = new google.maps.LatLng(37.7749,-122.4194);
  var myLatLngSC = new google.maps.LatLng(37.3541,-121.9552);
   
    var map = new google.maps.Map(document.getElementById("map"),
    {
        zoom: 9,
        center: myLatLngSanJose,
        mapTypeId: google.maps.MapTypeId.ROADMAP
    });

    var marker = new google.maps.Marker(
    {
        position: myLatLngSanJose,
        map: map,
        title: 'San Jose'
    });
 

      var markerfremont = new google.maps.Marker(
    {
        position:myLatLngFremont,
        map: map,
        title: 'Fremont'
    });
      var markermilpitas = new google.maps.Marker(
    {
        position:myLatLngMilpitas,
        map: map,
        title: 'Milpitas'
    });
      var markersfo = new google.maps.Marker(
    {
        position:myLatLngSFO,
        map: map,
        title: 'San Francisco'
    });
